    ...
    <main class="auth-cover-wrapper">
        <div class="auth-cover-content-inner">
            <div class="auth-cover-content-wrapper">
                <div class="auth-img">
                <img src="assets/images/pamlog.jpeg" style="width: 640px; height: 640px;">
                </div>
            </div>
        </div>
            ...
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    <div class="wd-50 mb-5">
                        <img src="assets/images/logo-admana.png" alt="" class="img-fluid">
                    </div>
                    <h2 class="fs-20 fw-bolder mb-4">Login</h2>
                    <h4 class="fs-13 fw-bold mb-2">Login ke akun anda</h4>
                    <p class="fs-12 fw-medium text-muted">Selamat Datang di Website PT.ADMANA, Silahkan login untuk melanjutkan</p>
