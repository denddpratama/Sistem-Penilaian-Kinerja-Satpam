        ...
        <div class="nxl-content">
            ...
            <div class="page-header d-flex align-items-center justify-content-between">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">💼 Data Jabatan</a></li>
                    </ul>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="card-header-btn">
                                                    <div data-bs-toggle="tooltip" title="Ubah" class="tooltip-wrapper">
                                                        <a href="{{ url('ubah-jabatan/'.$item->id) }}" class="btn btn-warning btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    </div>
                                                    <div data-bs-toggle="tooltip" title="Hapus" class="tooltip-wrapper">
                                                        <a href="{{ url('hapus-jabatan/'.$item->id) }}" class="btn btn-danger btn-icon" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
