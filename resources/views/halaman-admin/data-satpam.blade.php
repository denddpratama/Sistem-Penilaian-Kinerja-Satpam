    ...
    <div class="nxl-content">
        ...
        <div class="page-header d-flex align-items-center justify-content-between">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Data Profile Satpam</a></li>
                </ul>
            </div>
            <!-- Pindahkan tombol ke kanan -->
            <div class="page-header-right d-flex align-items-center gap-3">
                <a class="btn btn-primary" href="{{ url('tambah-satpam') }}">
                    Tambah
                </a>
            </div>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="card-header-btn">
                                                    ...
                                                    <div data-bs-toggle="tooltip" title="Ubah" class="tooltip-wrapper">
                                                        <a href="{{ url('ubah-satpam/'.$item->id) }}" class="btn btn-warning btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    </div>
                                                    <div data-bs-toggle="tooltip" title="Hapus" class="tooltip-wrapper">
                                                        <a href="{{ url('hapus-satpam/'.$item->id) }}" class="btn btn-danger btn-icon" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
